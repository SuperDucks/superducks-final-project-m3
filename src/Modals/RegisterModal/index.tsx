...
const RegisterModal = () => {
  ...
  const { setIsOpenModalRegister, registerUser, setIsOpenModal } = useContext(UserContext);
    ...
    <Modal>
      <div className="modal-content">
        <div className="title-container">
          ...
          <button className="close" onClick={() => setIsOpenModalRegister(false)}>
          ...
          <BtnPrimary type="submit" className="btn-submit" onClick={() => {
